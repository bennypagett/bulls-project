...
#response variable pts_per_min, explan variables eFGp, STL_MP, TOV_MP, Age,X3Pp,X2Pp,TRB

## Relationship between variables

## Age v PTS_per_MP
ggplot(df_nonTOT_clean, aes(x = Age, y = PTS_per_MP)) +
  geom_point(alhpa = 0.5, colour = "magenta") +
  geom_smooth(method = "lm")
...
## STL_MP v PTS_per_MP
ggplot(df_nonTOT_clean, aes(x = STL_MP, y = PTS_per_MP)) +
  geom_point(alhpa = 0.5, colour = "magenta") +
  geom_smooth(method = "lm")

## TOV_MP v PTS_per_MP
ggplot(df_nonTOT_clean, aes(x = TOV_MP, y = PTS_per_MP)) +
  geom_point(alhpa = 0.5, colour = "magenta") +
  geom_smooth(method = "lm")

## TRB v PTS_per_MP
ggplot(df_nonTOT_clean, aes(x = TRB, y = PTS_per_MP)) +
  geom_point(alhpa = 0.5, colour = "magenta") +
  geom_smooth(method = "lm")

## X3Pp v PTS_per_MP
ggplot(df_nonTOT_clean, aes(x = X3Pp, y = PTS_per_MP)) +
  geom_point(alhpa = 0.5, colour = "magenta") +
  geom_smooth(method = "lm")

## X2Pp v PTS_per_MP
ggplot(df_nonTOT_clean, aes(x = X2Pp, y = PTS_per_MP)) +
  geom_point(alhpa = 0.5, colour = "magenta") +
  geom_smooth(method = "lm")

##Muticollinearity - took out X3Pp and X2Pp as error figure margins too large
pairs(formula = ~ Age + eFGp + STL_MP + TOV_MP + TRB, data = df_nonTOT_clean)

...
ggplot(data = player_stats_tidy_filtered) +
  geom_histogram(mapping = aes(x = PTS), colour = "black", fill = "dodgerblue",
                 binwidth = 60)
...
player_stats_tidy %>%
  ggplot(mapping = aes(x = eFGp, y = EFF)) +
  geom_point() +
  geom_smooth(method = "lm")

player_stats_tidy %>%
  ggplot(mapping = aes(x = Tm_use_total, y = EFF)) +
  geom_point() +
  geom_smooth(method = "lm")

player_stats_tidy %>%
  ggplot(mapping = aes(x = TrV, y = eFGp)) +
  geom_point() +
  geom_smooth(method = "lm")

player_stats_tidy %>%
  ggplot(mapping = aes(x = salary, y = TrV)) +
  geom_point() +
  geom_smooth(method = "lm")
